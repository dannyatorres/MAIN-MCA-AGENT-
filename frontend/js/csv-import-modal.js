...
function createStandardRow(first, last, phone, company, email, originalRow) {
    return {
        ...
        'Email': email || '',
        'Address': getColumnValue(originalRow, ['Address', 'address', 'Address1']) || '',
        'City': getColumnValue(originalRow, ['City', 'city']) || '',
        'State': getColumnValue(originalRow, ['State', 'state']) || '',
        'Zip': getColumnValue(originalRow, ['Zip', 'zip', 'Zip Code']) || '',
