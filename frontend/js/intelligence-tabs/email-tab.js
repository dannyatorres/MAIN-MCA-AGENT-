    ...
    getLayoutHTML() {
        return `
            <div class="email-container" style="display: flex; flex-direction: column; height: 100%; background: #0f1115;">
                ...
                <div class="email-toolbar" style="padding: 12px 16px; border-bottom: 1px solid rgba(255,255,255,0.05); display: flex; align-items: center; justify-content: space-between;">
                    
                    <div style="flex: 1; max-width: 350px; position: relative; margin-right: 20px;">
                        <input type="text" id="emailSearchInput" class="search-field-clean" placeholder="Search emails..." 
                               style="width: 100%; height: 38px; background: #0d1117 !important; border: 1px solid #30363d !important; border-radius: 8px !important; padding: 0 12px 0 36px; color: white; font-size: 13px; outline: none; box-shadow: none !important;">
                    ...
                    <div class="action-group" style="display: flex; align-items: center; gap: 12px;">
                        ...
                        <button id="composeEmailBtn" title="Compose New Email" 
                                style="width: 38px; height: 38px; border-radius: 10px !important; background: linear-gradient(135deg, #2dd4bf 0%, #0ea5e9 100%) !important; border: none !important; cursor: pointer; display: flex; align-items: center; justify-content: center; color: #000; box-shadow: 0 0 15px rgba(45, 212, 191, 0.4); margin: 0 !important;">
                            <i class="fas fa-plus" style="font-weight: 800; font-size: 14px;"></i>
                        </button>

                        <button id="unreadOnlyBtn" title="Show Unread Only"
                                style="width: 38px; height: 38px; border-radius: 8px !important; background: #21262d !important; border: 1px solid #30363d !important; color: #8b949e; cursor: pointer; display: flex; align-items: center; justify-content: center; margin: 0 !important;">
                            <i class="fas a фильтр"></i>
                        </button>

                        <button id="refreshEmailBtn" title="Refresh" 
                                style="width: 38px; height: 38px; border-radius: 8px !important; background: #21262d !important; border: 1px solid #30363d !important; color: #8b949e; cursor: pointer; display: flex; align-items: center; justify-content: center; margin: 0 !important;">
